...
# 5. Cumulative cost line plot
cumulative_cost_series = np.cumsum(cost)
axs[4].plot(hours, cumulative_cost_series, marker='o', color='purple')
axs[4].set_ylabel("Cumulative Cost")
axs[4].set_title("Cumulative Cost Over Time")
